...
int transactions[STEPS] = -1; // -1 doesn't correspond to either of targets
...
init {
    transactions[0] = sheep;
    transactions[1] = farmer;
    transactions[2] = cabbage;
    transactions[3] = sheep;
    transactions[4] = wolf;
    transactions[5] = farmer;
    transactions[6] = sheep;
