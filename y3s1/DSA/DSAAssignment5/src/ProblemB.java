...
public class ProblemB {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            final int[] verticesCount = {0};

            graph.BFS(vertex -> {
                verticesCount[0]++;
            });

            result.append(verticesCount[0] == graph.vertices.size() ? "yes" : "no");

            graph.removeEdge(graph.getVertex("Vladikavkaz-R"), graph.getVertex("Tbilisi-G"), false);
