...
vals = sorted([53, 57, 59, 73, 95, 51, 55, 64, 75, 74, 63, 61, 58, 69, 54, 81, 85, 106, 110, 99, 77, 114, 31])
newvals = [56, 101, 91, 92, 93, 96, 94, 90, 98, 100, 20, 10, 40]

bt = BPlusTree.bulkload(vals, 3)
print(bt)
for val in newvals:
    bt.insert(val)
print()
